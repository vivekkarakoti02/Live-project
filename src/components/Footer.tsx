    ...
    <footer className="bg-[#050505] border-t border-white/5 pt-16 pb-8">
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            <h4 className="text-xs font-bold uppercase tracking-widest mb-6 text-white">Contact Info</h4>
            <ul className="space-y-3">
          ...
          <div>
            <h4 className="text-xs font-bold uppercase tracking-widest mb-6 text-white">Follow Us</h4>
        ...
        <div className="border-t border-white/5 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-6">
            <a href="#" className="text-xs text-[var(--color-text-muted)] hover:text-white">Privacy Policy</a>
            <a href="#" className="text-xs text-[var(--color-text-muted)] hover:text-white">Terms of Service</a>
          </div>
        </div>
      </div>
    </footer>
